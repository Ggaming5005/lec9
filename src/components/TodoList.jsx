  ...
  return (
    <Wrapper>
      <InputDiv onSubmit={addTodo} dark={dark}>
        <Checked onClick={handleChecked} checked={checked}>
          {checked && <Img src="src/assets/images/icon-check.svg" />}
        </Checked>
        <Input
          dark={dark}
          type="text"
      ...
      <TodosDiv dark={dark}>
        {(showFilter ? filteredTodo : todoList).map((elem) => (
          <TodoItem key={elem.id} dark={dark}>
            ...
            >
              {elem.completed && <Img src="src/assets/images/icon-check.svg" />}
            </Checked>
            <ListItem completed={elem.completed} dark={dark}>
              {elem.taskName}
            </ListItem>
            <Delete onClick={() => deleteTask(elem.id)}>
